...
+function(c){var k=function(d){c(d).on("click",'[data-dismiss="alert"]',this.close)};k.VERSION="3.3.5";k.TRANSITION_DURATION=150;k.prototype.close=function(d){function a(){f.detach().trigger("closed.bs.alert").remove()}var b=c(this),e=b.attr("data-target");e||(e=b.attr("href"),e=e&&e.replace(/.*(?=#[^\s]*$)/,""));var f=c(e);d&&d.preventDefault();f.length||(f=b.closest(".alert"));f.trigger(d=c.Event("close.bs.alert"));d.isDefaultPrevented()||(f.removeClass("in"),c.support.transition&&f.hasClass("fade")?
...
(e.prop("checked")!==this.$element.hasClass("active")&&(a=!1),this.$element.toggleClass("active"));e.prop("checked",this.$element.hasClass("active"));a&&e.trigger("change")}else this.$element.attr("aria-pressed",!this.$element.hasClass("active")),this.$element.toggleClass("active")};var d=c.fn.button;c.fn.button=k;c.fn.button.Constructor=h;c.fn.button.noConflict=function(){return c.fn.button=d,this};c(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(a){var b=c(a.target);
...
k.prototype.replaceArrow=function(d,a,b){this.arrow().css(b?"left":"top",50*(1-d/a)+"%").css(b?"top":"left","")};k.prototype.setContent=function(){var d=this.tip(),a=this.getTitle();d.find(".tooltip-inner")[this.options.html?"html":"text"](a);d.removeClass("fade in top bottom left right")};k.prototype.hide=function(d){function a(){"in"!=b.hoverState&&e.detach();b.$element.removeAttr("aria-describedby").trigger("hidden.bs."+b.type);d&&d()}var b=this,e=c(this.$tip),f=c.Event("hide.bs."+this.type);return this.$element.trigger(f),
f.isDefaultPrevented()?void 0:(e.removeClass("in"),c.support.transition&&e.hasClass("fade")?e.one("bsTransitionEnd",a).emulateTransitionEnd(k.TRANSITION_DURATION):a(),this.hoverState=null,this)};k.prototype.fixTitle=function(){var d=this.$element;(d.attr("title")||"string"!=typeof d.attr("data-original-title"))&&d.attr("data-original-title",d.attr("title")||"").attr("title","")};k.prototype.hasContent=function(){return this.getTitle()};k.prototype.getPosition=function(d){d=d||this.$element;var a=
d[0],b="BODY"==a.tagName;a=a.getBoundingClientRect();null==a.width&&(a=c.extend({},a,{width:a.right-a.left,height:a.bottom-a.top}));var e=b?{top:0,left:0}:d.offset();d={scroll:b?document.documentElement.scrollTop||document.body.scrollTop:d.scrollTop()};b=b?{width:c(window).width(),height:c(window).height()}:null;return c.extend({},a,d,b,e)};k.prototype.getCalculatedOffset=function(d,a,b,e){return"bottom"==d?{top:a.top+a.height,left:a.left+a.width/2-b/2}:"top"==d?{top:a.top-e,left:a.left+a.width/2-
b/2}:"left"==d?{top:a.top+a.height/2-e/2,left:a.left-b}:{top:a.top+a.height/2-e/2,left:a.left+a.width}};k.prototype.getViewportAdjustedDelta=function(d,a,b,e){var f={top:0,left:0};if(!this.$viewport)return f;var g=this.options.viewport&&this.options.viewport.padding||0,l=this.getPosition(this.$viewport);/right|left/.test(d)?(b=a.top-g-l.scroll,a=a.top+g-l.scroll+e,b<l.top?f.top=l.top-b:a>l.top+l.height&&(f.top=l.top+l.height-a)):(e=a.left-g,a=a.left+g+b,e<l.left?f.left=l.left-e:a>l.right&&(f.left=
l.left+l.width-a));return f};k.prototype.getTitle=function(){var d=this.$element,a=this.options;return d.attr("data-original-title")||("function"==typeof a.title?a.title.call(d[0]):a.title)};k.prototype.getUID=function(d){do d+=~~(1E6*Math.random());while(document.getElementById(d));return d};k.prototype.tip=function(){if(!this.$tip&&(this.$tip=c(this.options.template),1!=this.$tip.length))throw Error(this.type+" `template` option must consist of exactly 1 top-level element!");return this.$tip};k.prototype.arrow=
...
a.leave(a)):a.tip().hasClass("in")?a.leave(a):a.enter(a)};k.prototype.destroy=function(){var d=this;clearTimeout(this.timeout);this.hide(function(){d.$element.off("."+d.type).removeData("bs."+d.type);d.$tip&&d.$tip.detach();d.$tip=null;d.$arrow=null;d.$viewport=null})};var h=c.fn.tooltip;c.fn.tooltip=function(d){return this.each(function(){var a=c(this),b=a.data("bs.tooltip"),e="object"==typeof d&&d;!b&&/destroy|hide/.test(d)||(b||a.data("bs.tooltip",b=new k(this,e)),"string"!=typeof d||b[d]())})};
c.fn.tooltip.Constructor=k;c.fn.tooltip.noConflict=function(){return c.fn.tooltip=h,this}}(jQuery);
+function(c){var k=function(d,a){this.init("popover",d,a)};if(!c.fn.tooltip)throw Error("Popover requires tooltip.js");k.VERSION="3.3.5";k.DEFAULTS=c.extend({},c.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});k.prototype=c.extend({},c.fn.tooltip.Constructor.prototype);k.prototype.constructor=k;k.prototype.getDefaults=function(){return k.DEFAULTS};
...
e=new k(this,f));"string"==typeof a&&e[a]()})}k.VERSION="3.3.5";k.DEFAULTS={offset:10};k.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)};k.prototype.refresh=function(){var a=this,b="offset",e=0;this.offsets=[];this.targets=[];this.scrollHeight=this.getScrollHeight();c.isWindow(this.$scrollElement[0])||(b="position",e=this.$scrollElement.scrollTop());this.$body.find(this.selector).map(function(){var f=
...
h.VERSION="3.3.5";h.RESET="affix affix-top affix-bottom";h.DEFAULTS={offset:0,target:window};h.prototype.getState=function(a,b,e,f){var g=this.$target.scrollTop(),l=this.$element.offset(),m=this.$target.height();if(null!=e&&"top"==this.affixed)return e>g?"top":!1;if("bottom"==this.affixed)return null!=e?g+this.unpin<=l.top?!1:"bottom":a-f>=g+m?!1:"bottom";var n=null==this.affixed;l=n?g:l.top;return null!=e&&e>=g?"top":null!=f&&l+(n?m:b)>=a-f?"bottom":!1};h.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;
